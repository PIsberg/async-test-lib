...
**JUnit 5 & 6 concurrency stress testing — one annotation, 135 detectors**
...
1. **Add the dependency** to `build.gradle.kts`:
   ```kotlin
   testImplementation("se.deversity.async-test-lib:async-test-lib:1.8.0")
   ```
...
135 detectors enabled by default with a single flag, or cherry-pick:
