...
The library itself — annotations, config, the N×M runner, the JUnit extension, the 146 detectors,
...
<rule>Elements listed in <security_elements> are security-critical. Never weaken their security properties. Every proposed change must be explicitly reviewed for security impact.</rule>
  <scoped_rules>
    ...
    <element path="se.deversity.asynctest.AgentThreadHooks"/>
    ...
    <element path="se.deversity.asynctest.diagnostics.LazyCollectionMisuseDetector" rules=".claude/rules/async-test-detectors.md"/>
    ...
    <element path="se.deversity.asynctest.diagnostics.ScopeConfigurationMisuseDetector" rules=".claude/rules/async-test-detectors.md"/>
    <element path="se.deversity.asynctest.diagnostics.ScopeJoinerMisuseDetector" rules=".claude/rules/async-test-detectors.md"/>
    <element path="se.deversity.asynctest.diagnostics.ScopeResultEscapeDetector" rules=".claude/rules/async-test-detectors.md"/>
