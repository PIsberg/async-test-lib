...
│  └──────────────────────────────────┘                            │
│  ┌──────────────────────────────────┐                            │
│  │ async-test-1.1.0-javadoc.jar     │  (API docs)               │
...
│  ┌─────────────────────────────────────────────┐               │
│  │ git push origin v1.1.0  (version tag)      │               │
...
```
Trigger:  git push origin v1.1.0 (version tag)
...
1. USER: Update version in pom.xml
   pom.xml: <version>1.1.0</version> → <version>1.1.0</version>
...
3. USER: Create annotated tag
   $ git tag -a v1.1.0 -m "Release 1.1.0 - Bug fixes"
...
### Sources JAR (async-test-1.1.0-sources.jar)
```
Size: ~350 KB
...
### JavaDoc JAR (async-test-1.1.0-javadoc.jar)
```
Size: ~450 KB
...
- ⏳ Create first v1.1.0 tag to trigger release
