...
**135 detectors**, organized phase by phase in [DETECTOR_CATALOG.md](DETECTOR_CATALOG.md).
...
|----------|----------------|
| [execution-flow.md](architecture/execution-flow.md) | The `@AsyncTest` → extension → interceptor → runner → registry chain, and the key supporting types |
