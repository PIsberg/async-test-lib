...
- **Async Test Library**: Core testing framework with 139 detectors
...
- **Detector Modules** (139 detectors; the phase-by-phase catalog is [DETECTOR_CATALOG.md](../DETECTOR_CATALOG.md)):
