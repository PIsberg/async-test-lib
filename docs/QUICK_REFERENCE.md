...
```
Maven:   se.deversity.async-test-lib:async-test-lib:1.9.7
Gradle:  'se.deversity.async-test-lib:async-test-lib:1.9.7'
```
...
Maven Central (in future):
  se.deversity.async-test-lib:async-test-lib:1.9.7
