...
```
Maven:   se.deversity.async-test-lib:async-test-lib:1.12.0
Gradle:  'se.deversity.async-test-lib:async-test-lib:1.12.0'
```
...
Maven Central (in future):
  se.deversity.async-test-lib:async-test-lib:1.12.0
