...
```
Maven:   se.deversity.async-test-lib:async-test-lib:1.9.6
Gradle:  'se.deversity.async-test-lib:async-test-lib:1.9.6'
```
...
Maven Central (in future):
  se.deversity.async-test-lib:async-test-lib:1.9.6
