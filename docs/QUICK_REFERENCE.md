...
```
Maven:   se.deversity.async-test-lib:async-test-lib:1.9.8
Gradle:  'se.deversity.async-test-lib:async-test-lib:1.9.8'
```
...
Maven Central (in future):
  se.deversity.async-test-lib:async-test-lib:1.9.8
